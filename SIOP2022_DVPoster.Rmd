...
logoleft_name: '![](https://www.montclair.edu/university-communications/wp-content/uploads/sites/144//2020/10/hawk-logo-color.svg){.main-img-left}'
logoright_name: '![](https&#58;//cdn.minnesotamonthly.com/wp-content/uploads/sites/85/2019/02/Logo_UniversityofWisconsinSTOUT_RGB.png){.main-img-right}'
main_width: 0.3	
csl: "apa7.csl"
poster_height: "50in"
poster_width: "70in"
...
Regression analyses reveal that the more a work characteristic is perceived as a resource, the more engaged is the respondent ($R^2$ = .15, $F_{(7, 528)}$ = 12.82, $p$ < .001). The impact of challenge demands on engagement was similar in direction and magnitude to that of resources ($R^2$ = .13, $F_{(7, 528)}$ = 11.03, $p$ < .001), with null effects for both stress ($R^2$= .01, $F_{(7, 528)}$ = 0.88, $p$ = .520) and burnout ($R^2$ = .02, $F_{(7, 528)}$ = 1.21, $p$ = .295). There was a marginal association between a work characteristic perceived as a hindrance and lower levels of engagement ($R^2$ = .07, $F_{(7, 528)}$ = 5.84, $p$ < .001), with similar effects both between being viewed as a hindrance and increased stress ($R^2$ = .06, $F_{(7, 528)}$ = 4.88, $p$ < .001) and burnout ($R^2$ = .06, $F_{(7, 528)}$ = 4.90, $p$ < .001).

```{r ChallengePlot2, fig.cap="Challenge demand ratings (O*NET characteristic category association).", out.width="100%"}

corrplot(new2, type="lower", order="hclust", tl.col="black", tl.srt=45, diag=FALSE)

```

```{r HinderPlot2, fig.cap="Hindrance demand ratings (O*NET characteristic category association).", out.width="100%"}
