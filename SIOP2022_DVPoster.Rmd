...
```
**Figure 1.** *Observed dependent variable distributions*
...
```{r ChallengePlot2, out.width="100%"}

corrplot(new2, type="lower", order="hclust", tl.col="black", tl.srt=45, diag=FALSE)

```
**Figure 2.** *Challenge demand ratings (ONet characteristic category association).*

```{r HinderPlot2, out.width="100%"}

corrplot(new3, type="lower", order="hclust", tl.col="black", tl.srt=45, diag=FALSE)

```

**Figure 3.** *Hindrance demand ratings (ONet characteristic category association).*
