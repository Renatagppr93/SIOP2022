...
```{r figure2, fig.width=14, fig.height=7, fig.cap="Overall Top 8 Challenge Demands"}
challenge.overall.t
```
...
```{r figure3, fig.width=14, fig.height=7, fig.cap="Overall Top 8 Hindrance Demands"}
hindrance.overall.t
```
