...
```{r figure1, fig.width=14, fig.height=6}
resource.overall.t
```
Figure 1. Overall Top 10 Resources
```{r challenges}
labels <- read.csv("truncatedlabels.csv")            
...
```{r figure2, fig.width=14, fig.height=6}
challenge.overall.t
```
Figure 2. Overall Top 10 Challenge Demands
...
```{r figure3, fig.width=14, fig.height=6}
hindrance.overall.t
```
Figure 3. Overall Top 10 Hindrance Demands
